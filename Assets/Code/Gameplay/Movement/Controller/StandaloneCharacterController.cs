...
namespace Code.Gameplay.Movement.Controller
{
    ...
    // If ponadobitsa more, go fuck to original file and pizdi fichi from tyda
    public class StandaloneCharacterController : MonoBehaviour, ICharacterController, IStandaloneCharacterController
    {
        ...
        [Header("Misc")] public float BonusOrientationSharpness = 10f;
        ...
        public void SetPositionAndRotation(Vector3 position, Quaternion rotation) => Motor.SetPositionAndRotation(position, rotation);
