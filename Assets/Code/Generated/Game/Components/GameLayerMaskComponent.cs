...
public partial class GameEntity {
    ...
    public Code.Gameplay.Common.LayerMask layerMask { get { return (Code.Gameplay.Common.LayerMask)GetComponent(GameComponentsLookup.LayerMask); } }
    ...
    public GameEntity AddLayerMask(int newValue) {
        ...
        var component = (Code.Gameplay.Common.LayerMask)CreateComponent(index, typeof(Code.Gameplay.Common.LayerMask));
