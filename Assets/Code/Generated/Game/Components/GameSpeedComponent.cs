...
public partial class GameEntity {
    ...
    public Code.Gameplay.Common.Speed speed { get { return (Code.Gameplay.Common.Speed)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (Code.Gameplay.Common.Speed)CreateComponent(index, typeof(Code.Gameplay.Common.Speed));
